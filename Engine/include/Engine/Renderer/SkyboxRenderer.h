...
private:
    ...
    ID3D11DepthStencilState* m_depthState = nullptr; // non-owning; owned by RenderStateCache
    ID3D11RasterizerState*   m_rsState    = nullptr; // non-owning; owned by RenderStateCache
};
