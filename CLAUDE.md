# SlopEngine — Claude Working Document
...
- Editor is a separate CMake executable target that links SlopEngine.lib.
...
| # | Milestone |
|---|---|
| M69 | Editor shell — separate executable, links SlopEngine.lib, hosts an engine instance |
